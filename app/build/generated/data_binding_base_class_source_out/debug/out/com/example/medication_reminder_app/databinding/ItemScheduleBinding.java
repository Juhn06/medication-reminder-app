...
public final class ItemScheduleBinding implements ViewBinding {
  ...
  private ItemScheduleBinding(@NonNull LinearLayout rootView, @NonNull TextView tvScheduleTime) {
  ...
  public static ItemScheduleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemScheduleBinding((LinearLayout) rootView, tvScheduleTime);
    }
